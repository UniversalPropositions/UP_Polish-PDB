...
- `git clone https://github.com/UniversalPropositions/UP_Polish-PDB.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Polish-PDB>/ --input_up=<up_path_to_UP_Polish-PDB>/ --output=<path_to_UD+UP_Polish-PDB>/`
